...
class BooleanEvaluationModule:
    ...
    def extract_utility(self,scen, probabilities):
        variables_utilities=self.utility_algorithm.chooseNextConcept( scen.listExp_dnf,scen.listExp_cnf,scen.variables, probabilities,scen.variables_expressions_mapper)
        #print("Utilities: \n{}".format(utilities))
        utilities=scen.convert_variables_weight_to_pool_weights(variables_utilities)

        return utilities, variables_utilities
